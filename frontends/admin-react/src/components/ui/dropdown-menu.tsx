...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-44 overflow-hidden rounded-md border bg-card p-1 text-card-foreground shadow-xl",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-40 overflow-hidden rounded-md border bg-card p-1 text-card-foreground shadow-xl",
      className,
    )}
    {...props}
  />
